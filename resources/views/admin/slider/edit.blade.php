                    ...
                    <div class="card card-info col-12">
                        ...
                        <form method="post"  class="form-horizontal" action="{{url('KT_Admin/slider/update/'.$department->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Title _ar</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  name="title_ar"  value="{{$department->title_ar}}" >
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control" id="inputEmail3" name="des_ar" >{{$department->des_ar}} </textarea>
                                    </div>
