...
{{--                            <li class="breadcrumb-item"><a href="{{url('KT_Admin/gallery')}}">Trips</a></li>--}}
                            <li class="breadcrumb-item active">Trips Page</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Trips DataTable </h3>
                                        ...
                                        <div class="modal fade" id="modal-danger{{$row->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-success">
                                                    ...
                                                    <form method="post"  class="form-horizontal" action="{{url('KT_Admin/trip/update/'.$row->id)}}" enctype="multipart/form-data">
                                                        {{csrf_field()}}
